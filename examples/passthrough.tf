...
output "psql_passthrough_id" {
  value       = azurecaf_naming_convention.passthrough_psql.id
  description = "Id of the resource's name"
}

output "psql_passthrough" {
  value       = azurecaf_naming_convention.passthrough_psql.result
  description = "Random result based on the resource type"
}
