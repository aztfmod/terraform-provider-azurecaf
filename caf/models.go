...
var Resources = map[string]ResourceStructure{
	...
	"kv":   {"keyvault", "kv", 3, 24, alphanumh, "^[a-zA-Z][0-9A-Za-z,-]{0,22}[0-9a-zA-Z]{0,1}$"},
	...
	"vnet": {"virtual network", "vnet", 1, 80, alphanumhup, "^[0-9a-zA-Z][0-9A-Za-z,_,.,-]{0,79}[0-9a-zA-Z,_]{0,1}$"},
	...
	"gen":  {"generic", "vml-", 1, 24, alphanum, "^[0-9a-zA-Z]{1,24}$"},
}
